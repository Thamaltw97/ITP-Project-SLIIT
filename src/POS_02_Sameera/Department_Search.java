 ...
 * @author Owner
 */
public class Department_Search extends javax.swing.JFrame {
    ...
    private void u_idActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_u_idActionPerformed
        ...
        Item_Details.jTextField4.setText(x);
        Item_Details.jLabel17.setText(y);
        this.dispose();
    ...
    private void u_idKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_u_idKeyReleased
        ...
        try {
            ...
            if (jRadioButton1.isSelected()) {
                Query = "select * from department where  id like '%" + u_id.getText() + "%'";
            } else if (jRadioButton2.isSelected()) {
                Query = "select * from department where  description like '%" + u_id.getText() + "%'";
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Department_Search.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Department_Search().setVisible(true);
            }
        });
    }
 ...
 private void search() {
        DefaultTableModel df = (DefaultTableModel) jTable2.getModel();
        try {
            ResultSet rs = DB.MyDB.search("select * from department");
            df.setRowCount(0);
            while (rs.next()) {
                Vector v = new Vector();
                v.add(rs.getString("id"));
