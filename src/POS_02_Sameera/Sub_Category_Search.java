...
import static POS_02_Sameera.Category_Search.jTable2;
 ...
 * @author Owner
 */
public class Sub_Category_Search extends javax.swing.JFrame {

    /**
     * Creates new form PO_Search
     */
    public Sub_Category_Search() {
        initComponents();
        search();
    }
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Search By"));
        ...
        jRadioButton2.setText("Description");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addComponent(u_id, javax.swing.GroupLayout.PREFERRED_SIZE, 324, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(38, 38, 38))
    ...
    private void u_idActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_u_idActionPerformed
        ...
        Item_Details.jTextField6.setText(x);
        Item_Details.jLabel19.setText(y);
        this.dispose();
    ...
    private void u_idKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_u_idKeyReleased
        ...
        try {
            String Query = "";
            if (jRadioButton1.isSelected()) {
                Query = "select * from sub_category where  id like '%" + u_id.getText() + "%'";
            } else if (jRadioButton2.isSelected()) {
                Query = "select * from sub_category where  description like '%" + u_id.getText() + "%'";
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sub_Category_Search.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sub_Category_Search().setVisible(true);
            }
        });
    }
 ...
 private void search() {
        DefaultTableModel df = (DefaultTableModel) jTable2.getModel();
        try {
            ResultSet rs = DB.MyDB.search("select * from sub_category");
            df.setRowCount(0);
            while (rs.next()) {
                Vector v = new Vector();
                v.add(rs.getString("id"));
