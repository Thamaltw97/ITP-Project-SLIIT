 ...
 * @author Owner
 */
public class Category_Details_1 extends javax.swing.JFrame {

    /**
     * Creates new form Purchase_Order
     */
    public Category_Details_1() {
        initComponents();
        generateID();
    }
    ...
    private void initComponents() {
        ...
        jLabel15.setText("Category Details");
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        try {
            ResultSet rs = DB.MyDB.search("select * from category where id='" + jTextField1.getText() + "'");
            if (rs.next()) {
                ...
                try {
                    ...
                    if (i == 0) {
                        if (jButton4.getText().equals("Save")) {
                            DB.MyDB.iud("insert into category values('" + jTextField1.getText() + "','" + jTextField2.getText() + "')");
                            ...
                            DB.MyDB.iud("update category set description='" + jTextField2.getText() + "' where id='" + jTextField1.getText() + "'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Category_Details_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Category_Details_1().setVisible(true);
            }
        });
    }
