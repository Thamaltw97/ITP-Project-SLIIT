...
public class Category_Search extends javax.swing.JFrame {
    ...
    private void u_idActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_u_idActionPerformed
        ...
        Item_Details.jTextField5.setText(x);
        Item_Details.jLabel18.setText(y);
        this.dispose();
    ...
    private void u_idKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_u_idKeyReleased
        ...
        try {
            ...
            if (jRadioButton1.isSelected()) {
                Query = "select * from category where  id like '%" + u_id.getText() + "%'";
            } else if (jRadioButton2.isSelected()) {
                Query = "select * from category where  description like '%" + u_id.getText() + "%'";
            }
    ...
    private void search() {
        DefaultTableModel df = (DefaultTableModel) jTable2.getModel();
        try {
            ResultSet rs = DB.MyDB.search("select * from category");
            df.setRowCount(0);
            while (rs.next()) {
                Vector v = new Vector();
                v.add(rs.getString("id"));
