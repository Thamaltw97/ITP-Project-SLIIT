 ...
 * @author Owner
 */
public class Sub_Category_Details_1 extends javax.swing.JFrame {

    /**
     * Creates new form Purchase_Order
     */
    public Sub_Category_Details_1() {
        initComponents();
        generateID();
    }
    ...
    private void initComponents() {
        ...
        jLabel15.setText("Sub Category Details");

        jLabel9.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel9.setText("Sub Category Description");
        ...
        jLabel13.setText("Sub Category ID");
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        try {
            ResultSet rs = DB.MyDB.search("select * from sub_category where id='" + jTextField1.getText() + "'");
            if (rs.next()) {
                ...
                try {
                    ...
                    if (i == 0) {
                        if (jButton4.getText().equals("Save")) {
                            DB.MyDB.iud("insert into sub_category values('" + jTextField1.getText() + "','" + jTextField2.getText() + "')");
                            ...
                            DB.MyDB.iud("update sub_category set description='" + jTextField2.getText() + "' where id='" + jTextField1.getText() + "'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sub_Category_Details_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sub_Category_Details_1().setVisible(true);
            }
        });
    }
