 ...
 * @author Janiya's PC
 */
public class CO_Invoice extends javax.swing.JPanel {

    /**
     * Creates new form CO_Invoice
     */
    public CO_Invoice() {
        initComponents();
        generateInvoiceID();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            ...
            jLabel29.setText((String) jTable1.getModel().getValueAt(row, 2));
    ...
    private void jTextField5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField5ActionPerformed
        try {
            ...
            if (rs.next()) {
                ...
                jLabel29.setText(rs.getString("description"));
                jTextField9.grabFocus();
            }
        } catch (Exception e) {
...
//        }
    ...
    private void jTextField11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField11ActionPerformed
        ...
        float net = (Float.valueOf(amount.getText()) - (Float.valueOf(amount.getText())) * ((Float.valueOf(jTextField11.getText())) / 100));

        net_amount.setText(String.valueOf(net));
    }//GEN-LAST:event_jTextField11ActionPerformed

    private void jTextField11KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField11KeyReleased

        if (jTextField11.getText().trim().isEmpty()) {
            net_amount.setText(String.valueOf(tot));
        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            DB.MyDB.iud("INSERT INTO customer_order_invoice VALUES ('" + jTextField3.getText() + "','" + jTextField1.getText() + "','" + jLabel7.getText() + "','" + jLabel5.getText() + "','" + amount.getText() + "','" + net_amount.getText() + "')");
        ...
        try {
            ...
            while (j != model.getRowCount()) {
                ...
                DB.MyDB.iud("INSERT INTO customer_order_invoice_has_item VALUES ('" + jTextField3.getText() + "','" + model.getValueAt(j, 1) + "','" + model.getValueAt(j, 3) + "','" + model.getValueAt(j, 4) + "','" + model.getValueAt(j, 5) + "','" + model.getValueAt(j, 6) + "','" + model.getValueAt(j, 2) + "')");
                j++;
            }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (k == 1) {
            ...
            if (a == 0) {
                ...
                totCost = Float.valueOf(jLabel5.getText());
                totCost = totCost + (cost * m);
                System.out.println(totCost);
                jLabel5.setText(String.valueOf(totCost));       //jLabel4 = temparory label to gather total Cost.

                totSell = Float.valueOf(jLabel7.getText());
                totSell = totSell + (sell * m);
                System.out.println(totSell);
                jLabel7.setText(String.valueOf(totSell));
 ...
 private void generateInvoiceID() {
        try {
            ResultSet rs = DB.MyDB.search("SELECT Max(idcustomer_order_invoice) FROM customer_order_invoice");
            if (rs.next()) {
                jTextField3.setText(Integer.parseInt(rs.getString("max(idcustomer_order_invoice)")) + 1 + "");
                jButton5.setText("Save");
            } else {
                jButton5.setText("Save");
