 ...
 * @author Owner
 */
public class CO_Search extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order No", "Customer", "Order Date", "Status"
            }
        ) {
        ...
        jRadioButton1.setText("Order No");
        ...
        jRadioButton3.setText("Pending Orders");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Order Date", "Order No", "Customer Name", "Order Status" }));
    ...
    private void u_idKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_u_idKeyReleased
        ...
        try {
            ...
            if (jRadioButton1.isSelected()) {
                query = "SELECT * FROM customer_order where idCustomer_Order like '" + u_id.getText() + "%'";
            } else if (jRadioButton2.isSelected()) {
                query = "SELECT * FROM customer_order where customer_idcustomer like '" + u_id.getText() + "%'";
            }
            ResultSet rs = DB.MyDB.search(query);
            df.setRowCount(0);
            while (rs.next()) {
                Vector v = new Vector();
                v.add(rs.getString("idCustomer_Order"));
                v.add(rs.getString("customer_idcustomer"));
    ...
    private void jTable2KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable2KeyReleased
        ...
        if (c == evt.VK_DELETE) {
            ...
            try {
                DB.MyDB.iud("DELETE FROM customer_order WHERE idCustomer_Order=" + cell);
                search();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CO_Search.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void search() {
        DefaultTableModel df = (DefaultTableModel) jTable2.getModel();
        try {
            ResultSet rs = DB.MyDB.search("SELECT * FROM customer_order");
            df.setRowCount(0);
            while (rs.next()) {
                Vector v = new Vector();
                v.add(rs.getString("idCustomer_Order"));
